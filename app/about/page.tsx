    ...
    <main className="mx-auto max-w-3xl px-4 py-10 sm:py-14">
      ...
      <section className="mt-10 space-y-3">
        ...
        <ul className="list-inside list-disc space-y-1 text-sm leading-relaxed text-slate-700">
          ...
          <li>
            <strong>経歴・役職</strong>：5市計 約191名分を整備済み（合計 344件のマイルストーン。議長・副議長・各党会派長・委員会委員長・副委員長を中心に、本人公式サイト・政党公式・議会公式からの一次情報をもとに記載、各項目に出典URLと確認日を付与）。残り 約 171名分は今後の更新で順次拡充。
          </li>
          <li>
          ...
          <li>
            <strong>公式SNS・本人サイト</strong>：5市計 約124名分について、本人公式X / Facebook / Instagram / 本人公式サイトのいずれかを掲載済み（reason 内の本人発信確認済みアカウントのみ）。残りは今後の更新で順次拡充。
          </li>
          <li>
        ...
        <p className="mt-3 text-sm leading-relaxed text-slate-700">
          整備状況のリアルタイム数字（経歴・役職 整備済み議員数 等）は<Link href="/" className="underline">トップページ</Link>に掲載しています。本ページの数字は 2026-05-30 時点のものです。
        </p>
      </section>
